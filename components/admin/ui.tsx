...
const controlClass =
  "w-full rounded-xl border border-[var(--adm-field-border)] bg-[var(--adm-field)] px-4 text-[15px] text-[var(--adm-text)] outline-none transition-[border-color,box-shadow] placeholder:text-[var(--adm-faint)] focus:border-brand-accent/60 focus:ring-2 focus:ring-brand-accent/20";
