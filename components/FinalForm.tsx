...
const inputClass =
  "h-11 rounded-xl bg-[#e8e8e8] px-4 text-[15px] text-brand-ink outline-none transition-[background-color,box-shadow] duration-100 placeholder:text-[#999999] focus:bg-white focus:ring-2 focus:ring-brand-accent/35";
          ...
          <form className="rounded-2xl bg-[#f8f8f8] p-6 sm:p-8" noValidate onSubmit={handleSubmit}>
            <div className="grid gap-5">
              ...
              <label className="grid gap-1.5 text-[13px] text-[#666666]">
                ...
                <textarea
                  className="site-scroll min-h-[118px] resize-y rounded-xl bg-[#e8e8e8] px-4 py-3 text-[15px] text-brand-ink outline-none transition-[background-color,box-shadow] duration-100 placeholder:text-[#999999] focus:bg-white focus:ring-2 focus:ring-brand-accent/35"
                  name="message"
